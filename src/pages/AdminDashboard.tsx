        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="flex-1 p-6 overflow-auto">
            <Routes>
              ...
              <Route path="/schedule" element={<div className="p-6"><h2 className="text-2xl font-bold">Jadwal Kegiatan</h2><p className="text-muted-foreground">Halaman ini akan segera tersedia</p></div>} />
              <Route path="/messages" element={<div className="p-6"><h2 className="text-2xl font-bold">Pesan & Chat</h2><p className="text-muted-foreground">Halaman ini akan segera tersedia</p></div>} />
              <Route path="/settings" element={<div className="p-6"><h2 className="text-2xl font-bold">Pengaturan Sistem</h2><p className="text-muted-foreground">Halaman ini akan segera tersedia</p></div>} />
              <Route path="/help" element={<div className="p-6"><h2 className="text-2xl font-bold">Bantuan</h2><p className="text-muted-foreground">Halaman ini akan segera tersedia</p></div>} />
              <Route path="/export" element={<div className="p-6"><h2 className="text-2xl font-bold">Export Data</h2><p className="text-muted-foreground">Halaman ini akan segera tersedia</p></div>} />
            </Routes>
          </main>
        </div>
      </div>
